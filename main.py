...
# --- 1. PROMPT ACTUALIZADO (BARBERIA ESTILAZO) ---
BARBER_PROMPT = """
...
def gestionar_reserva(datos, chat_id):
    try:
        ...
        return f"✅ ¡Listo {nombre}! Cita agendada en Barberia Estilazo para el {fecha}."
    except Exception as e: return f"Error reservando: {str(e)}"

# --- CORRECCIÓN "T" INCLUIDA EN CANCELAR Y REPROGRAMAR ---
...
# --- 5. RECORDATORIOS (CON RANGO DE FECHAS) ---
...
def home(): return jsonify({"status": "online", "barberia": "Estilazo 💈"})
